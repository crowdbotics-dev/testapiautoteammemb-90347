...
## Project Structure
    ...
    ├── testapiautoteammemb_90347  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_90347`
...
2. Clone this repo and `cd testapiautoteammemb_90347`
